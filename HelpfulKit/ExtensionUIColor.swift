...
extension UIColor {
    ...
    ///
    /// - parameter red: red color component value ranges from 0 to 255 or hex code of red component value rages from 0x01 to 0xFF.
    /// - parameter green: green color component value ranges from 0 to 255 or hex code of green component value rages from 0x01 to 0xFF.
    /// - parameter blue: blue color component value ranges from 0 to 255 or hex code of blue component value rages from 0x01 to 0xFF.
