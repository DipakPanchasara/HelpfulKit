...
extension Date {
    ...
    func toTime(isGlobalOrLocal: Bool) -> Date {
        ...
        let seconds = isGlobalOrLocal ?
        -TimeInterval(timezone.secondsFromGMT(for: self)) :
        TimeInterval(timezone.secondsFromGMT(for: self))
    ...
    var graphDate: String {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = .DateFormat.DateFormatyyyyMMddTxt
        return dateFormatter.string(from: self)
    }
    var monthOfDateInInt: String {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = .DateFormat.DateFormatMMTxt
        return dateFormatter.string(from: self)
    }
...
extension String {
    struct DateFormat {
        ...
        static let DateFormatHHTxt = "HH"
        static let DateFormatyyyyMMddTxt = "yyyy-MM-dd"
        static let MonthDateYearFormatTypeI  = "mm/dd/yyyy"
        static let MonthDateYearFormatTypeII  = "MM/dd/yyyy"
        static let MonthDateYearFormatTypeIII = "yyyy-MM-dd"
        static let DateFormatSweepstakesTypeI  = "yyyy-MM-dd'T'HH:mm:ss"
        static let MessagingDateTimeTypeFormatTxt = "yyyy'-'MM'-'dd'T'HH':'mm':'ss"
        static let DateFormatDayTypeI = "E, d MMM yyyy HH:mm:ss"
        static let DateFormatDayTypeII = "h:mm a EEEE, MMMM d, yyyy"
        static let DateFormatDayTypeIII = "h:mm a MM/dd/yyyy"
        static let DateFormatTypeIV  = "MM/dd/yyyy hh:mm a"
        static let DateFormatDate = "MMM d, yyyy h:mm a"
    }
}
